                ...
                searchField.on('keyup paste', function() {
                    ...
                    keyPressTimeout = setTimeout( function() {
                        ...
                        if(searchTerm.length < 3) {
                            ...
                            var ajaxData = {
                                action: 'verdure_mikado_search_post_types',
                                term: searchTerm,
                                postType: postType
                            };
	...
	function mkdfInitBlogPagination(){
		...
		var initMainPagFunctionality = function(thisHolder) {
			...
			if(nextPage <= maxNumPages){
				...
				var ajaxData = mkdf.modules.common.setLoadMoreAjaxData(loadMoreDatta, 'verdure_mikado_blog_load_more');
    ...
    function mkdfInitBlogListShortcodePagination(){
        ...
        var initMainPagFunctionality = function(thisHolder, pagedLink) {
            ...
            if(nextPage <= maxNumPages){
                ...
                var ajaxData = mkdf.modules.common.setLoadMoreAjaxData(loadMoreDatta, 'verdure_mikado_blog_shortcode_load_more');
...
(function($) {
    ...
    function mkdfInitLoadMoreItemsPortfolioFilter($portfolioList, $filterValue, $filterClassName) {
        ...
        var	loadMoreDatta = mkdf.modules.common.getLoadMoreData(thisPortList),
            nextPage = loadMoreDatta.nextPage,
	        ajaxData = mkdf.modules.common.setLoadMoreAjaxData(loadMoreDatta, 'verdure_core_portfolio_ajax_load_more'),
                ...
                success: function (data) {
                    ...
                    thisPortList.waitForImages(function () {
                        ...
                        if(portListHasArticles) {
                            setTimeout(function() {
								mkdf.modules.common.setFixedImageProportionSize(thisPortList, thisPortListInner.find('article'), thisPortListInner.find('.qodef-pl-grid-sizer').width());
	...
	function mkdfInitPortfolioPagination(){
		...
		var initMainPagFunctionality = function(thisPortList, pagedLink) {
			...
			if(nextPage <= maxNumPages || maxNumPages === 0){
				...
				var ajaxData = mkdf.modules.common.setLoadMoreAjaxData(loadMoreDatta, 'verdure_core_portfolio_ajax_load_more');
