...
class VerdureMikadoRecentPosts extends VerdureMikadoWidget {
	public function __construct() {
		parent::__construct(
			'mkdf_recent_posts',
			esc_html__( 'Mikado Recent Posts', 'verdure' ),
			array( 'description' => esc_html__( 'Select recent posts that you would like to display', 'verdure' ) )
		);
	...
	public function widget( $args, $instance ) {
        ...
        if ( $query->have_posts() ) {
            ...
            $html .= esc_html__('Sorry, there are no posts matching your criteria', 'verdure');
        }
