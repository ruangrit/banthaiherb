...
class VerdureMikadoAuthorInfoWidget extends VerdureMikadoWidget {
	public function __construct() {
		parent::__construct(
			'mkdf_author_info_widget',
			esc_html__( 'Mikado Author Info Widget', 'verdure' ),
			array( 'description' => esc_html__( 'Add author info element to widget areas', 'verdure' ) )
		);
	...
	protected function setParams() {
		$this->params = array(
			...
			array(
				...
				'title' => esc_html__( 'Author Username', 'verdure' )
			)
		);
	}
		...
		<div class="widget mkdf-author-info-widget <?php echo esc_attr( $extra_class ); ?>">
			<div class="mkdf-aiw-inner">
				<a itemprop="url" class="mkdf-aiw-image" href="<?php echo esc_url( get_author_posts_url( $authorID ) ); ?>">
					<?php echo verdure_mikado_kses_img( get_avatar( $authorID, 138 ) ); ?>
				</a>
				<?php if ( $author_info !== "" ) { ?>
