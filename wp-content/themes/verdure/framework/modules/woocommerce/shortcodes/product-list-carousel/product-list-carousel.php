...
namespace VerdureCore\CPT\Shortcodes\ProductListCarousel;
...
class ProductListCarousel implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Mikado Product List - Carousel', 'verdure' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Number Of Visible Items', 'verdure' ),
							'value'       => array(
							...
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'verdure' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'slider_loop',
							'heading'     => esc_html__( 'Enable Slider Loop', 'verdure' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Autoplay', 'verdure' ),
							'value'       => array_flip( verdure_mikado_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'verdure' )
						),
						array(
							...
							'heading'     => esc_html__( 'Slide Duration', 'verdure' ),
							'description' => esc_html__( 'Default value is 5000 (ms)', 'verdure' ),
							'group'       => esc_html__( 'Slider Settings', 'verdure' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'slider_speed_animation',
							'heading'     => esc_html__( 'Slide Animation Duration', 'verdure' ),
							'description' => esc_html__( 'Speed of slide animation in milliseconds. Default value is 600.', 'verdure' ),
							'group'       => esc_html__( 'Slider Settings', 'verdure' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'slider_navigation',
							'heading'     => esc_html__( 'Enable Slider Navigation Arrows', 'verdure' ),
							'value'       => array_flip( verdure_mikado_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'verdure' )
						),
						array(
							...
							'heading'    => esc_html__( 'Slider Navigation Skin', 'verdure' ),
							'value'      => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Pagination', 'verdure' ),
							'value'       => array_flip( verdure_mikado_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'verdure' )
						),
						array(
							...
							'heading'    => esc_html__( 'Slider Pagination Skin', 'verdure' ),
							'value'      => array(
								esc_html__( 'Default', 'verdure' ) => 'default',
								esc_html__( 'Light', 'verdure' )   => 'light'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Slider Pagination Position', 'verdure' ),
							'value'      => array(
								esc_html__( 'Below Carousel', 'verdure' )  => 'bellow-slider',
								esc_html__( 'Inside Carousel', 'verdure' ) => 'inside-slider'
							),
							'dependency' => array( 'element' => 'slider_pagination', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Slider Settings', 'verdure' )
						),
	...
	public function render( $atts, $content = null ) {
		...
		$html = verdure_mikado_get_woo_shortcode_module_template_part( 'templates/product-list', 'product-list-carousel', $params['type'], $params, $additional_params );
