...
if ( ! function_exists('verdure_mikado_contact_form_7_options_map') ) {

	function verdure_mikado_contact_form_7_options_map() {
		
		verdure_mikado_add_admin_page(
			array(
				'slug'  => '_contact_form7_page',
				'title' => esc_html__( 'Contact Form 7', 'verdure' ),
				'icon'  => 'fa fa-envelope-o'
			)
		);
		
		$panel_contact_form_style_1 = verdure_mikado_add_admin_panel(
			array(
				'page'  => '_contact_form7_page',
				'name'  => 'panel_contact_form_style_1',
				'title' => esc_html__( 'Custom Style 1', 'verdure' )
			)
		);
		
		//Text Typography
		
		$typography_text_group = verdure_mikado_add_admin_group(
			array(
				'name'        => 'typography_text_group',
				'title'       => esc_html__( 'Form Text Typography', 'verdure' ),
				'description' => esc_html__( 'Setup typography for form elements text', 'verdure' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_text_row1 = verdure_mikado_add_admin_row(
			array(
		...
		verdure_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Text Color', 'verdure' ),
			)
		);
		...
		$typography_text_row2 = verdure_mikado_add_admin_row(
			array(
		...
		$typography_text_row3 = verdure_mikado_add_admin_row(
			array(
		...
		$typography_label_group = verdure_mikado_add_admin_group(
			array(
				'name'        => 'typography_label_group',
				'title'       => esc_html__( 'Form Label Typography', 'verdure' ),
				'description' => esc_html__( 'Setup typography for form elements label', 'verdure' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_label_row1 = verdure_mikado_add_admin_row(
			array(
		...
		$typography_label_row2 = verdure_mikado_add_admin_row(
			array(
		...
		$background_border_group = verdure_mikado_add_admin_group(
			array(
				'name'        => 'background_border_group',
				'title'       => esc_html__( 'Form Elements Background and Border', 'verdure' ),
				'description' => esc_html__( 'Setup form elements background and border style', 'verdure' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$background_border_row1 = verdure_mikado_add_admin_row(
			array(
		...
		verdure_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Color', 'verdure' )
			)
		);
		...
		verdure_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Transparency', 'verdure' )
			)
		);
		
		$background_border_row2 = verdure_mikado_add_admin_row(
			array(
		...
		verdure_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Transparency', 'verdure' ),
			)
		);
		...
		verdure_mikado_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Focus Border Color', 'verdure' )
			)
		);
		...
		verdure_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Border Transparency', 'verdure' )
			)
		);
		
		$background_border_row3 = verdure_mikado_add_admin_row(
			array(
		...
		verdure_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Width', 'verdure' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		verdure_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Radius', 'verdure' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$padding_group = verdure_mikado_add_admin_group(
			array(
				'name'        => 'padding_group',
				'title'       => esc_html__( 'Elements Padding', 'verdure' ),
				'description' => 'Setup form elements padding',
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$padding_row = verdure_mikado_add_admin_row(
			array(
				'name'   => 'padding_row',
		...
		verdure_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Top', 'verdure' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		verdure_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Right', 'verdure' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		verdure_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Bottom', 'verdure' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		verdure_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left', 'verdure' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$margin_group = verdure_mikado_add_admin_group(
			array(
				'name'        => 'margin_group',
				'title'       => esc_html__( 'Elements Margin', 'verdure' ),
				'description' => esc_html__( 'Setup form elements margin', 'verdure' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$margin_row = verdure_mikado_add_admin_row(
			array(
				'name'   => 'margin_row',
				'parent' => $margin_group
			)
		...
		verdure_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Textarea Height', 'verdure' ),
				'description'   => esc_html__( 'Enter height for textarea form element', 'verdure' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$button_typography_group = verdure_mikado_add_admin_group(
			array(
				'name'        => 'button_typography_group',
				'title'       => esc_html__( 'Button Typography', 'verdure' ),
				'description' => esc_html__( 'Setup button text typography', 'verdure' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_typography_row1 = verdure_mikado_add_admin_row(
			array(
		...
		verdure_mikado_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Hover Text Color', 'verdure' )
			)
		);
		...
		$button_typography_row2 = verdure_mikado_add_admin_row(
			array(
		...
		$button_background_border_group = verdure_mikado_add_admin_group(
			array(
				'name'        => 'button_background_border_group',
				'title'       => esc_html__( 'Button Background and Border', 'verdure' ),
				'description' => esc_html__( 'Setup button background and border style', 'verdure' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_background_border_row1 = verdure_mikado_add_admin_row(
			array(
		...
		verdure_mikado_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Background Hover Color', 'verdure' )
			)
		);
		...
		verdure_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Background Hover Transparency', 'verdure' )
			)
		);
		
		$button_background_border_row2 = verdure_mikado_add_admin_row(
			array(
		...
		verdure_mikado_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Border Hover Color', 'verdure' )
			)
		);
		...
		verdure_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Hover Transparency', 'verdure' )
			)
		);
		
		$button_background_border_row3 = verdure_mikado_add_admin_row(
			array(
		...
		verdure_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Height', 'verdure' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		verdure_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Left/Right Padding', 'verdure' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$panel_contact_form_style_2 = verdure_mikado_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'verdure')
		));

		//Text Typography

		$typography_text_group = verdure_mikado_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'verdure'),
			'description'	=> esc_html__('Setup typography for form elements text', 'verdure'),
		...
		$typography_text_row1 = verdure_mikado_add_admin_row(array(
			'name'		=> 'typography_text_row1',
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row2 = verdure_mikado_add_admin_row(array(
			'name'		=> 'typography_text_row2',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row3 = verdure_mikado_add_admin_row(array(
			'name'		=> 'typography_text_row3',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_label_group = verdure_mikado_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'verdure'),
			'description'	=> esc_html__('Setup typography for form elements label', 'verdure'),
			'parent'		=> $panel_contact_form_style_2
		...
		$typography_label_row1 = verdure_mikado_add_admin_row(array(
			'name'		=> 'typography_label_row1',
			'parent'	=> $typography_label_group
		));
		...
		$typography_label_row2 = verdure_mikado_add_admin_row(array(
			'name'		=> 'typography_label_row2',
			'next'		=> true,
			'parent'	=> $typography_label_group
		));
		...
		$background_border_group = verdure_mikado_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'verdure'),
			'description'	=> esc_html__('Setup form elements background and border style', 'verdure'),
			'parent'		=> $panel_contact_form_style_2
		...
		$background_border_row1 = verdure_mikado_add_admin_row(array(
			'name'		=> 'background_border_row1',
			'parent'	=> $background_border_group
		));
		...
		$background_border_row2 = verdure_mikado_add_admin_row(array(
			'name'		=> 'background_border_row2',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$background_border_row3 = verdure_mikado_add_admin_row(array(
			'name'		=> 'background_border_row3',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$padding_group = verdure_mikado_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'verdure'),
			'description'	=> 'Setup form elements padding',
			'parent'		=> $panel_contact_form_style_2
		...
		$padding_row = verdure_mikado_add_admin_row(array(
			'name'		=> 'padding_row',
			'parent'	=> $padding_group
		));
		...
		$margin_group = verdure_mikado_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'verdure'),
			'description'	=> esc_html__('Setup form elements margin', 'verdure'),
			'parent'		=> $panel_contact_form_style_2
		...
		$margin_row = verdure_mikado_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = verdure_mikado_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'verdure'),
			'description'	=> esc_html__('Setup button text typography', 'verdure'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_typography_row1 = verdure_mikado_add_admin_row(array(
			'name'		=> 'button_typography_row1',
			'parent'	=> $button_typography_group
		));
		...
		$button_typography_row2 = verdure_mikado_add_admin_row(array(
			'name'		=> 'button_typography_row2',
			'next'		=> true,
			'parent'	=> $button_typography_group
		));
		...
		$button_background_border_group = verdure_mikado_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'verdure'),
			'description'	=> esc_html__('Setup button background and border style', 'verdure'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_background_border_row1 = verdure_mikado_add_admin_row(array(
			'name'		=> 'button_background_border_row1',
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row2 = verdure_mikado_add_admin_row(array(
			'name'		=> 'button_background_border_row2',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row3 = verdure_mikado_add_admin_row(array(
			'name'		=> 'button_background_border_row3',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
        ...
        $panel_contact_form_style_3 = verdure_mikado_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'verdure')
        ));
        ...
        $typography_label_row3 = verdure_mikado_add_admin_row(array(
        ...
        $button_typography_row3 = verdure_mikado_add_admin_row(array(
	...
	add_action( 'verdure_mikado_options_map', 'verdure_mikado_contact_form_7_options_map', 20);
}