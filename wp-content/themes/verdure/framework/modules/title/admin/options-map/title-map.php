...
if ( ! function_exists( 'verdure_mikado_get_title_types_options' ) ) {
	function verdure_mikado_get_title_types_options() {
		$title_type_options = apply_filters( 'verdure_mikado_title_type_global_option', $title_type_options = array() );
		
		return $title_type_options;
	}
}

if ( ! function_exists( 'verdure_mikado_get_title_type_default_options' ) ) {
	function verdure_mikado_get_title_type_default_options() {
		$title_type_option = apply_filters( 'verdure_mikado_default_title_type_global_option', $title_type_option = '' );
...
if ( ! function_exists('verdure_mikado_title_options_map') ) {
	function verdure_mikado_title_options_map() {
		$title_type_options        = verdure_mikado_get_title_types_options();
		$title_type_default_option = verdure_mikado_get_title_type_default_options();
		...
		$panel_title = verdure_mikado_add_admin_panel(
			array(
				'page' => '_title_page',
				'name' => 'panel_title',
				'title' => esc_html__('Title Settings', 'verdure')
			)
		);
		...
		verdure_mikado_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'This option will enable/disable Title Area', 'verdure' ),
				'parent'        => $panel_title
			)
		);
		
			$show_title_area_container = verdure_mikado_add_admin_container(
				array(
					'parent'          => $panel_title,
				...
				verdure_mikado_add_admin_field(
					...
					verdure_mikado_add_admin_field(
						array(
							...
							'description'   => esc_html__( 'Specify title vertical alignment', 'verdure' ),
							'parent'        => $show_title_area_container,
							'options'       => array(
		...
		do_action( 'verdure_mikado_additional_title_area_options_map', $show_title_area_container );
		
		/***************** Additional Title Area Layout - end *****************/
		
		
		$panel_typography = verdure_mikado_add_admin_panel(
			array(
				'page'  => '_title_page',
			...
			$group_page_title_styles = verdure_mikado_add_admin_group(
				array(
					'name'        => 'group_page_title_styles',
					'title'       => esc_html__( 'Title', 'verdure' ),
					'description' => esc_html__( 'Define styles for page title', 'verdure' ),
					'parent'      => $panel_typography
				)
			);
		
				$row_page_title_styles_1 = verdure_mikado_add_admin_row(
					array(
				...
				$row_page_title_styles_2 = verdure_mikado_add_admin_row(
					array(
				...
				$row_page_title_styles_3 = verdure_mikado_add_admin_row(
					array(
			...
			verdure_mikado_add_admin_section_title(
				array(
					...
					'title'  => esc_html__( 'Subtitle', 'verdure' ),
					'parent' => $panel_typography
				)
			);
		
			$group_page_subtitle_styles = verdure_mikado_add_admin_group(
				array(
					'name'        => 'group_page_subtitle_styles',
					'title'       => esc_html__( 'Subtitle', 'verdure' ),
					'description' => esc_html__( 'Define styles for page subtitle', 'verdure' ),
					'parent'      => $panel_typography
				)
			);
		
				$row_page_subtitle_styles_1 = verdure_mikado_add_admin_row(
					array(
				...
				$row_page_subtitle_styles_2 = verdure_mikado_add_admin_row(
					array(
				...
				$row_page_subtitle_styles_3 = verdure_mikado_add_admin_row(
					array(
		...
		do_action( 'verdure_mikado_additional_title_typography_options_map', $panel_typography );
		
		/***************** Additional Title Typography Layout - end *****************/
    }

	add_action( 'verdure_mikado_options_map', 'verdure_mikado_title_options_map', 6);
}