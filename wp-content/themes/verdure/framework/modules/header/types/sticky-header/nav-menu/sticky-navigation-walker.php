...
if (!class_exists('VerdureMikadoStickyNavigationWalker')) {
	class VerdureMikadoStickyNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($depth==0){
				if($item->type_menu == "wide") {
					...
					$wide_type = verdure_mikado_options()->getOptionValue('wide_dropdown_style');
					if ( $wide_type !== '') {
