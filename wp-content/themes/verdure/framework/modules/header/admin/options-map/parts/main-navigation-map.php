...
if ( ! function_exists( 'verdure_mikado_get_hide_dep_for_header_main_menu_options' ) ) {
	function verdure_mikado_get_hide_dep_for_header_main_menu_options() {
		$hide_dep_options = apply_filters( 'verdure_mikado_header_main_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'verdure_mikado_header_main_navigation_options_map' ) ) {
	function verdure_mikado_header_main_navigation_options_map() {
		$hide_dep_options = verdure_mikado_get_hide_dep_for_header_main_menu_options();
		
		$panel_main_menu = verdure_mikado_add_admin_panel(
			array(
				'title'           => esc_html__( 'Main Menu', 'verdure' ),
		...
		verdure_mikado_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Main Menu General Settings', 'verdure' )
			)
		);
		...
		verdure_mikado_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Wide Dropdown Style', 'verdure' ),
				'options'		=> array(
					'full-width' => esc_html__('Full Width','verdure'),
					'in-grid'	 => esc_html__('In Grid', 'verdure'),
					'centered'	 => esc_html__('Centered', 'verdure'),
				)
			)
		);
		
		$drop_down_group = verdure_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'drop_down_group',
				'title'       => esc_html__( 'Main Dropdown Menu', 'verdure' ),
				'description' => esc_html__( 'Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'verdure' )
			)
		);
		
		$drop_down_row1 = verdure_mikado_add_admin_row(
			array(
		...
		verdure_mikado_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Main Dropdown Menu Appearance', 'verdure' ),
				'description'   => esc_html__( 'Choose appearance for dropdown menu', 'verdure' ),
				'options'       => array(
					'dropdown-default'        => esc_html__( 'Default', 'verdure' ),
					'dropdown-animate-height' => esc_html__( 'Animate Height', 'verdure' )
				)
			)
		);
		...
		$first_level_group = verdure_mikado_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Define styles for 1st level in Top Navigation Menu', 'verdure' )
			)
		);
		...
		verdure_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Active Text Color', 'verdure' ),
			)
		);
		...
		verdure_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Hover Text Color', 'verdure' ),
			)
		);
		...
		verdure_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Active Text Color', 'verdure' ),
			)
		);
		
		$first_level_row4 = verdure_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		verdure_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Hover Text Color', 'verdure' ),
			)
		);
		...
		verdure_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Active Text Color', 'verdure' ),
			)
		);
		
		$first_level_row5 = verdure_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row6 = verdure_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row7 = verdure_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		verdure_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left/Right', 'verdure' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		verdure_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Left/Right', 'verdure' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_group = verdure_mikado_add_admin_group(
			array(
				...
				'title'       => esc_html__( '2nd Level Menu', 'verdure' ),
				'description' => esc_html__( 'Define styles for 2nd level in Top Navigation Menu', 'verdure' )
			)
		);
		...
		verdure_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hover/Active Color', 'verdure' )
			)
		);
		...
		$second_level_wide_group = verdure_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_wide_group',
				'title'       => esc_html__( '2nd Level Wide Menu', 'verdure' ),
				'description' => esc_html__( 'Define styles for 2nd level in Wide Menu', 'verdure' )
			)
		);
		
		$second_level_wide_row1 = verdure_mikado_add_admin_row(
			array(
		...
		$second_level_wide_row2 = verdure_mikado_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$second_level_wide_row3 = verdure_mikado_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$third_level_group = verdure_mikado_add_admin_group(
			array(
				...
				'title'       => esc_html__( '3nd Level Menu', 'verdure' ),
				'description' => esc_html__( 'Define styles for 3nd level in Top Navigation Menu', 'verdure' )
			)
		);
		...
		$third_level_row3 = verdure_mikado_add_admin_row(
			array(
				'parent' => $third_level_group,
		...
		$third_level_wide_group = verdure_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_wide_group',
				'title'       => esc_html__( '3rd Level Wide Menu', 'verdure' ),
				'description' => esc_html__( 'Define styles for 3rd level in Wide Menu', 'verdure' )
			)
		);
		
		$third_level_wide_row1 = verdure_mikado_add_admin_row(
			array(
		...
		$third_level_wide_row2 = verdure_mikado_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$third_level_wide_row3 = verdure_mikado_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
	...
	add_action( 'verdure_mikado_header_main_navigation_options_map', 'verdure_mikado_header_main_navigation_options_map', 10, 1 );
}