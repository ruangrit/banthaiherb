...
if ( ! function_exists( 'verdure_mikado_get_blog_holder_classes' ) ) {
	/**
	 * Function that generates blog holder classes for blog page
	 */
	function verdure_mikado_get_blog_holder_classes( $classes ) {
	...
	add_filter( 'verdure_mikado_blog_holder_classes', 'verdure_mikado_get_blog_holder_classes' );
}
