<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <div class="mkdf-post-content">
        <div class="mkdf-post-text <?php echo esc_attr($content_class);?>" <?php verdure_mikado_inline_style($post_background_image)?>>
            <div class="mkdf-post-text-inner">
                    <div class="mkdf-post-info">
                    <span class="mkdf-post-icon">
                        <svg class="mkdf-post-link-image" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="99.297px" height="32.714px" viewBox="0 0 99.297 32.714" enable-background="new 0 0 99.297 32.714" xml:space="preserve">
                        <g>
    ...
    <div class="mkdf-post-info-bottom clearfix">
        <div class="mkdf-post-info-bottom-left">
            <?php verdure_mikado_get_module_template_part('templates/parts/post-info/tags', 'blog', '', $part_params); ?>
            <?php verdure_mikado_get_module_template_part('templates/parts/post-info/comments', 'blog', '', $part_params); ?>
            <?php verdure_mikado_get_module_template_part('templates/parts/post-info/like', 'blog', '', $part_params); ?>
        </div>
        <div class="mkdf-post-info-bottom-right">
            <?php verdure_mikado_get_module_template_part('templates/parts/post-info/share', 'blog', '', $part_params); ?>
        </div>
    </div>
</article>