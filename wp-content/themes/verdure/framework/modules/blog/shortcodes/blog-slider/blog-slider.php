<?php
namespace VerdureCore\CPT\Shortcodes\BlogSlider;
...
class BlogSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Mikado Blog Slider', 'verdure' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
							esc_html__( 'Slider', 'verdure' )            => 'slider',
							esc_html__( 'Carousel', 'verdure' )          => 'carousel',
							esc_html__( 'Carousel Centered', 'verdure' ) => 'carousel-centered'
						),
						'save_always' => true
					),
					array(
	...
	public function render( $atts, $content = null ) {
		...
		verdure_mikado_get_module_template_part( 'shortcodes/blog-slider/holder', 'blog', '', $params );
