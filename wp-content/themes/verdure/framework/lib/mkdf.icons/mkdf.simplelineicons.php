...
class VerdureMikadoSimpleLineIcons implements iVerdureMikadoIconCollection {
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'verdure'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'verdure'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'verdure'),
            'icon-social-facebook'    => esc_html__('Facebook', 'verdure'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'verdure'),
            'icon-social-github'      => esc_html__('Github', 'verdure'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'verdure'),
            'icon-social-instagram'   => esc_html__('Instagram', 'verdure'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'verdure'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'verdure'),
            'icon-social-reddit'      => esc_html__('Reddit', 'verdure'),
            'icon-social-skype'       => esc_html__('Skype', 'verdure'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'verdure'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'verdure'),
            'icon-social-spotify'     => esc_html__('Spotify', 'verdure'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'verdure'),
            'icon-social-twitter'     => esc_html__('Twitter', 'verdure'),
            'icon-social-youtube'     => esc_html__('Youtube', 'verdure')
        );
    }
