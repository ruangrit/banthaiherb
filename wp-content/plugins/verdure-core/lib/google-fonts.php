<?php
if ( ! function_exists( 'verdure_mikado_init_google_fonts_array' ) ) {
	function verdure_mikado_init_google_fonts_array() {
		...
		$verdure_mikado_fonts_array = $google_fonts_decoded['items'];
	}
	add_action('after_setup_theme', 'verdure_mikado_init_google_fonts_array');
}