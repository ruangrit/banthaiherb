...
class PortfolioProjectInfo implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Mikado Portfolio Project Info', 'verdure-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Selected Project', 'verdure-core' ),
							'settings'    => array(
								'sortable'      => true,
								'unique_values' => true
							),
							'description' => esc_html__( 'If you left this field empty then project ID will be of the current page', 'verdure-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'project_info_type',
							'heading'     => esc_html__( 'Project Info Type', 'verdure-core' ),
							'value'       => array(
								esc_html__( 'Title', 'verdure-core' )          => 'title',
								esc_html__( 'Category', 'verdure-core' )       => 'category',
								esc_html__( 'Tag', 'verdure-core' )            => 'tag',
								esc_html__( 'Author', 'verdure-core' )         => 'author',
								esc_html__( 'Date', 'verdure-core' )           => 'date',
								esc_html__( 'Featured Image', 'verdure-core' ) => 'image'
							),
							'admin_label' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Project Title Tag', 'verdure-core' ),
							'value'       => array_flip( verdure_mikado_get_title_tag( true, array( 'p' => 'p' ) ) ),
							'description' => esc_html__( 'Set title tag for project title element', 'verdure-core' ),
							'dependency'  => array( 'element' => 'project_info_type', 'value' => array( 'title' ) )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'project_info_title',
							'heading'     => esc_html__( 'Project Info Label', 'verdure-core' ),
							'description' => esc_html__( 'Add project info label before project info element/s', 'verdure-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'project_info_title_tag',
							'heading'    => esc_html__( 'Project Info Label Tag', 'verdure-core' ),
							'value'      => array_flip( verdure_mikado_get_title_tag( true, array( 'p' => 'p' ) ) ),
