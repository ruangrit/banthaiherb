<?php
$masonry_classes = '';
$number_of_columns = verdure_mikado_get_meta_field_intersect('portfolio_single_masonry_columns_number');
if(!empty($number_of_columns)) {
	$masonry_classes .= ' mkdf-ps-'.$number_of_columns.'-columns';
}
$space_between_items = verdure_mikado_get_meta_field_intersect('portfolio_single_masonry_space_between_items');
...
<div class="mkdf-grid-row">
	<div class="mkdf-grid-col-8">
		<?php verdure_core_get_cpt_single_module_template_part('templates/single/parts/content', 'portfolio', $item_layout); ?>
	</div>
