...
class ItemShowcaseItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Mikado Item Showcase List Item', 'verdure-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						array(
							...
							'heading'     => esc_html__( 'Item Position', 'verdure-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Item Title', 'verdure-core' ),
							'admin_label' => true
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'item_link',
							'heading'    => esc_html__( 'Item Link', 'verdure-core' ),
							'dependency' => array( 'element' => 'item_title', 'not_empty' => true )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'item_target',
							'heading'     => esc_html__( 'Item Target', 'verdure-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Item Title Tag', 'verdure-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Item Title Color', 'verdure-core' ),
							'dependency' => array( 'element' => 'item_title', 'not_empty' => true )
						),
						array(
							'type'       => 'textarea',
							'param_name' => 'item_text',
							'heading'    => esc_html__( 'Item Text', 'verdure-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'item_text_color',
							'heading'    => esc_html__( 'Item Text Color', 'verdure-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		$html = verdure_core_get_shortcode_module_template_part( 'templates/item-showcase-item', 'item-showcase', '', $params );
