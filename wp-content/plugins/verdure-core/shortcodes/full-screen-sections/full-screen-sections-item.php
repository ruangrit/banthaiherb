<?php
namespace VerdureCore\CPT\Shortcodes\FullScreenSections;
...
class FullScreenSectionsItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Mikado Full Screen Sections Item', 'verdure-core' ),
					'base'            => $this->base,
					...
					'params'          => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Background Image Position', 'verdure-core' ),
							'description' => esc_html__( 'Please insert position in format horizontal vertical position, example - center center', 'verdure-core' ),
							'dependency'  => array('item' => 'background_image', 'not_empty' => true)
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'background_size',
							'heading'     => esc_html__( 'Background Image Size', 'verdure-core' ),
							'value'       => array(
								esc_html__( 'Cover', 'verdure-core' )   => 'cover',
								esc_html__( 'Contain', 'verdure-core' ) => 'contain',
								esc_html__( 'Inherit', 'verdure-core' ) => 'inherit'
							),
							'save_always' => true,
							'dependency'  => array('item' => 'background_image', 'not_empty' => true)
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'padding',
							'heading'     => esc_html__( 'Content Padding', 'verdure-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left. You can use px or %', 'verdure-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'vertical_alignment',
							'heading'     => esc_html__( 'Content Vertical Alignment', 'verdure-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Content Horizontal Alignment', 'verdure-core' ),
							'value'       => array(
								esc_html__( 'Default', 'verdure-core' ) => '',
						...
						array(
							...
							'description' => esc_html__( 'Set custom link around item', 'verdure-core' )
						),
						array(
							'type'       => 'dropdown',
						...
						array(
							...
							'heading'     => esc_html__( 'Header and Navigation Skin', 'verdure-core' ),
							'value'       => array(
								esc_html__( 'Default', 'verdure-core' ) => '',
							...
							'save_always' => true,
							'description' => esc_html__( 'Choose a predefined header style for header elements and for full screen sections navigation/pagination', 'verdure-core' )
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_laptop',
							'heading'     => esc_html__('Background Image for Laptops', 'verdure-core'),
							'group'       => esc_html__('Responsiveness', 'verdure-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_tablet',
							'heading'     => esc_html__('Background Image for Tablets - Landscape', 'verdure-core'),
							'group'       => esc_html__('Responsiveness', 'verdure-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_tablet_portrait',
							'heading'     => esc_html__('Background Image for Tablets - Portrait', 'verdure-core'),
							'group'       => esc_html__('Responsiveness', 'verdure-core')
						),
						array(
							'type'        => 'attach_image',
							'param_name'  => 'image_mobile',
							'heading'     => esc_html__('Background Image for Mobiles', 'verdure-core'),
							'group'       => esc_html__('Responsiveness', 'verdure-core')
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = verdure_core_get_shortcode_module_template_part( 'templates/full-screen-sections-item', 'full-screen-sections', '', $params );
