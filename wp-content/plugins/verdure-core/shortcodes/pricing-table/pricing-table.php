...
class PricingTable implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Mikado Pricing Table', 'verdure-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						array(
							...
							'value'       => array(
								esc_html__( 'One', 'verdure-core' )   => 'mkdf-one-column',
								esc_html__( 'Two', 'verdure-core' )   => 'mkdf-two-columns',
								esc_html__( 'Three', 'verdure-core' ) => 'mkdf-three-columns',
								esc_html__( 'Four', 'verdure-core' )  => 'mkdf-four-columns',
								esc_html__( 'Five', 'verdure-core' )  => 'mkdf-five-columns',
							),
							'save_always' => true
						),
						array(
