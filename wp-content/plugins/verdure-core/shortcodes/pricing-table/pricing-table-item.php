<?php
namespace VerdureCore\CPT\Shortcodes\PricingTable;
...
class PricingTableItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Mikado Pricing Table Item', 'verdure-core' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						...
						array(
							...
							'heading'		=> esc_html__('Choose Top Area Content','verdure-core'),
							'value'			=> array(
								esc_html__('Title','verdure-core') => 'title',
								esc_html__('Price','verdure-core') => 'price',
							)
						),
						array(
                            'type'        => 'attach_image',
                            'param_name'  => 'background_image',
                            'heading'     => esc_html__( 'Top Area Background Image', 'verdure-core' ),
                        ...
                        array(
                            ...
                            'heading'     => esc_html__( 'Box Background Image', 'verdure-core' ),
                            'description' => esc_html__( 'Select image from media library', 'verdure-core' ),
                            'group'      => esc_html__( 'Design Options', 'verdure-core' )
                        ),
						array(
							...
							'heading'    => esc_html__( 'Top Area Bottom Border Color', 'verdure-core' ),
							'group'      => esc_html__( 'Design Options', 'verdure-core' )
						),
						array(
							'type'       => 'colorpicker',
						...
						array(
							...
							'value'       => esc_html__( 'Basic Plan', 'verdure-core' ),
							'save_always' => true
						),
						array(
							'type'       => 'colorpicker',
						...
						array(
							'type'       => 'textfield',
							'param_name' => 'price',
							'heading'    => esc_html__( 'Price', 'verdure-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'price_color',
							'heading'    => esc_html__( 'Price Color', 'verdure-core' ),
						...
						array(
							'type'        => 'textfield',
							'param_name'  => 'currency',
							'heading'     => esc_html__( 'Currency', 'verdure-core' ),
							'description' => esc_html__( 'Default mark is $', 'verdure-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'currency_color',
							'heading'    => esc_html__( 'Currency Color', 'verdure-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Price Period', 'verdure-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'price_period_color',
							'heading'    => esc_html__( 'Price Period Color', 'verdure-core' ),
						...
						array(
							...
							'value'       => esc_html__( 'BUY NOW', 'verdure-core' ),
							'save_always' => true
						),
						array(
							'type'       => 'textfield',
						...
						array(
							'type'       => 'textarea_html',
							'param_name' => 'content',
							'heading'    => esc_html__( 'Content', 'verdure-core' ),
	...
	public function render( $atts, $content = null ) {
		...
		$html = verdure_core_get_shortcode_module_template_part( 'templates/pricing-table-template', 'pricing-table', '', $params );
    ...
    private function getBoxStyle( $params ) {
        ...
        if ( ! empty( $params['box_background_image'] ) ) {
            $id = $params['box_background_image'];
            $image_original = wp_get_attachment_image_src( $id, 'full' );
            $style[] = "background-image: url('".$image_original[0]."')";
        }
        return implode(';', $style);
