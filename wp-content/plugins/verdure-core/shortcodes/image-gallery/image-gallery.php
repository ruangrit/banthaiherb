<?php
namespace VerdureCore\CPT\Shortcodes\ImageGallery;
...
class ImageGallery implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Mikado Image Gallery', 'verdure-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type',
							'heading'     => esc_html__( 'Gallery Type', 'verdure-core' ),
							'value'       => array(
								esc_html__( 'Image Grid', 'verdure-core' )		=> 'grid',
								esc_html__( 'Masonry', 'verdure-core' )    		=> 'masonry',
								esc_html__( 'Masonry Fixed', 'verdure-core' )		=> 'masonry-fixed',
								esc_html__( 'Slider', 'verdure-core' )			=> 'slider',
								esc_html__( 'Carousel', 'verdure-core' )			=> 'carousel'
							),
							'save_always' => true,
							'admin_label' => true
						),
						array(
							'type'        => 'attach_images',
							'param_name'  => 'images',
							'heading'     => esc_html__( 'Images', 'verdure-core' ),
							'description' => esc_html__( 'Select images from media library', 'verdure-core' )
						),
						array(
							'type'        => 'textfield',
						...
						array(
							...
							'heading'    => esc_html__( 'Image Hover', 'verdure-core' ),
							'value'      => array(
								esc_html__( 'Shader', 'verdure-core' )           => 'shader',
								esc_html__( 'Zoom', 'verdure-core' )             => 'zoom',
								esc_html__( 'Zoom and Shader', 'verdure-core' )    => 'zoom-shader',
						...
						array(
							...
							'heading'     => esc_html__( 'Custom Links', 'verdure-core' ),
							'description' => esc_html__( 'Delimit links by comma', 'verdure-core' ),
						...
						array(
							...
							'value'       => array(
								esc_html__( 'Two', 'verdure-core' )   => 'two',
								esc_html__( 'Three', 'verdure-core' ) => 'three',
								esc_html__( 'Four', 'verdure-core' )  => 'four',
								esc_html__( 'Five', 'verdure-core' )  => 'five',
								esc_html__( 'Six', 'verdure-core' )   => 'six'
							),
							'save_always' => true,
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Padding', 'verdure-core' ),
							'description' => esc_html__( 'Padding left and right on stage (can see neighbours).', 'verdure-core' ),
							'value'       => array_flip( verdure_mikado_get_yes_no_select_array( false ) ),
							'save_always' => true,
	...
	public function render( $atts, $content = null ) {
		...
		$html = verdure_core_get_shortcode_module_template_part( 'templates/' . $slug, 'image-gallery', '', $params );
