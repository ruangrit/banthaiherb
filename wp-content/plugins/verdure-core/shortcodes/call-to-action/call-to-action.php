<?php
namespace VerdureCore\CPT\Shortcodes\CallToAction;
...
class CallToAction implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Mikado Call To Action', 'verdure-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Set Content In Grid', 'verdure-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Elements Proportion', 'verdure-core' ),
							'value'      => array(
								esc_html__( '80/20', 'verdure-core' ) => '80',
								esc_html__( '75/25', 'verdure-core' ) => '75',
								esc_html__( '66/33', 'verdure-core' ) => '66',
								esc_html__( '50/50', 'verdure-core' ) => '50'
							),
							'dependency' => array( 'element' => 'layout', 'value' => array( 'normal' ) )
						),
						array(
						...
						array(
							...
							'heading'    => esc_html__( 'Button Top Margin (px)', 'verdure-core' ),
						...
						array(
							...
							'value'      => esc_html__( 'I am test text for Call to Action shortcode content', 'verdure-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = verdure_core_get_shortcode_module_template_part( 'templates/call-to-action', 'call-to-action', '', $params );
	...
	private function getButtonHolderStyles( $params ) {
		...
		if ( ! empty( $params['button_top_margin'] ) && $params['layout'] === 'simple' ) {
			$styles[] = 'margin-top: ' . verdure_mikado_filter_px( $params['button_top_margin'] ) . 'px';
		}
