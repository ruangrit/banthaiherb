<?php
namespace VerdureRestaurant\CPT;

use VerdureRestaurant\Lib;

/**
 * Class PostTypesLoader
 * @package VerdureRestaurant\CPT
 */
class PostTypesRegister {
    ...
    private function addPostTypes() {
	    $cpt_class_name = apply_filters('verdure_restaurant_filter_register_custom_post_types', $cpt_class_name = array());
