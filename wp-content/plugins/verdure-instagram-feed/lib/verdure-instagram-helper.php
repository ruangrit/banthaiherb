...
/**
 * Class VerdureInstagramHelper
 */
class VerdureInstagramHelper {
    /**
     * Generates HTML for given image from Instagram feed. Defines verdure_instagram_image_atts filter
    ...
    public function getImageHTML($image, $imageSize) {
        ...
        $imageAtts = apply_filters('verdure_instagram_image_atts',
            array(
                'class' => $imageSize,
