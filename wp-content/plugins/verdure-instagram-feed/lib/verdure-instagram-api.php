...
include 'verdure-instagram-helper.php';

/**
 * Class VerdureInstagramApi
 */
class VerdureInstagramApi {
    /**
    ...
    private $apiURL;
    /**
     * @var VerdureInstagramApi instance of current class
     */
    private static $instance;

    /**
     * Helper object
     * @var VerdureInstagramHelper
     */
    private $helper;

    const CODE_OPTION_NAME = 'verdure_instagram_code';
    const USER_ID_OPTION_NAME = 'verdure_instagram_user_id';
    const ACCESS_TOKEN_OPTION_NAME = 'verdure_instagram_access_token';
    const CODE_REDIRECT_URI_OPTION_NAME = 'verdure_instagram_code_redirect_uri';
    ...
    private function __construct() {
        ...
        $this->helper = new VerdureInstagramHelper();
    }
     ...
     * @return string
     *
     * @see VerdureInstagramApi::buildCurrentPageURI()
     */
     ...
     *
     * @see VerdureInstagramApi::fetchData()
     */
     ...
     * @return stdClass
     *
     * @see VerdureInstagramApi::getAccessToken()
     */
