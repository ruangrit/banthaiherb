...
class QMNQuizManager {
	...
	public function submit_results( $qmn_quiz_options, $qmn_array_for_variables ) {
		...
		// Rti Hack for thaiherb web

		$products_in_quiz = array(
			1 =>  array(
					1 => array("4270","4276"), 
					2 => array("4274", "4268", "4009", "4014"), 
					3 => array("4274", "4268", "4270", "3992", "4276", "4325")
					),
			2 => array(
					1 => array("4325"),
					2 => array("4325"),
			...
			4 => array(
					1 => array("4270", "4268", "4272"),
					2 => array("4268"),
					3 => array("4270")
				),
			5 => array(
					1 => array("4011"),
					2 => array("3992", "4013", "4266"),
					3 => array("4266")
				),
			);
		// Map product in quiz
		$result_of_quiz1 = $results_array[1][0]['points'];
		$result_of_quiz2 = $results_array[1][1]['points'];
		$result_of_quiz3 = $results_array[1][2]['points'];
		$result_of_quiz4 = $results_array[1][3]['points'];
		$result_of_quiz5 = $results_array[1][4]['points'];

		$prd_q1 = $products_in_quiz[1][$result_of_quiz1];
		$prd_q2 = $products_in_quiz[2][$result_of_quiz2];
		$prd_q3 = $products_in_quiz[3][$result_of_quiz3];
		$prd_q4 = $products_in_quiz[4][$result_of_quiz4];
		$prd_q5 = $products_in_quiz[5][$result_of_quiz5];

		$prd_list = array();
		foreach ($prd_q1 as $key => $value) {
			$prd_list[] = $value;
		}
		foreach ($prd_q2 as $key => $value) {
			$prd_list[] = $value;
		}
		foreach ($prd_q3 as $key => $value) {
			$prd_list[] = $value;
		}
		foreach ($prd_q4 as $key => $value) {
			$prd_list[] = $value;
		}
		foreach ($prd_q5 as $key => $value) {
			$prd_list[] = $value;
		}
